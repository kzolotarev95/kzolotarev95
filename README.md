...
Привет! Я **kzolotarev95** — делаю инструменты для **OpenWrt**, **LuCI**, роутеров, VPN-сценариев, автоматизации, Telegram-интеграций и удобного управления сетевой инфраструктурой.
